...
- [重新認識函式](function/01_重新認識函式.py)
  ![重新認識函式-1](function/images/01-參數記憶體分析-1.png)
  ![重新認識函式-2](function/images/01-參數記憶體分析-2.png)
  ![重新認識函式-3](function/images/01-參數記憶體分析-3.png)
  ![重新認識函式-4](function/images/01-參數記憶體分析-4.png)
...
- [淺拷貝與深拷貝](function/12_淺拷貝_深拷貝.py)
  ![淺拷貝與深拷貝-1](function/images/12_淺拷貝_深拷貝-1.png)
  ![淺拷貝與深拷貝-2](function/images/12_淺拷貝_深拷貝-2.png)
  ![淺拷貝與深拷貝-3](function/images/12_淺拷貝_深拷貝-3.png)
  ![淺拷貝與深拷貝-4](function/images/12_淺拷貝_深拷貝-4.png)
  ![淺拷貝與深拷貝-5](function/images/12_淺拷貝_深拷貝-5.png)
  ![淺拷貝與深拷貝-6](function/images/12_淺拷貝_深拷貝-6.png)
  ![淺拷貝與深拷貝-7](function/images/12_淺拷貝_深拷貝-7.png)
...
- [記憶體分析](memory/01_記憶體分析.py)
  - 不可變對象記憶體分析圖示：
    ![不可變對象-1](./memory/images/不可變對象-記憶體分析-1.png)
    a=888
    ![不可變對象-2](./memory/images/不可變對象-記憶體分析-2.png)
    ![不可變對象-3](./memory/images/不可變對象-記憶體分析-3.png)
  - 可變對象記憶體分析圖示：
    ![可變對象-1](./memory/images/可變對象-記憶體分析-1.png)
    stu_list[0]='阿三'
    ![可變對象-2](./memory/images/可變對象-記憶體分析-2.png)
  - 可變對象記憶體分析圖示：
    ![可變對象-1](./memory/images/可變對象-對象記憶體分析-1.png)
    ![可變對象-2](./memory/images/可變對象-對象記憶體分析-2.png)
