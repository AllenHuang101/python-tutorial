...
print(Fore.GREEN + "----- 元組中的可變元素 -----")
t2 = (28, 67, 21, 67, 11, [100, 200, 300, ("你好", "尚矽谷")])
# 元組中元素不可修改
# t2[5] = 400
# 元組中可變元素（列表）中的內容可以修改
t2[5][2] = 400
# 元組中可變元素（列表）中的巢狀元素（元組）中的內容仍不可修改
# t2[5][3][0] = "hello"
print(t2)

# 定義空元組
print(Fore.GREEN + "----- 定義空元組 -----")
t1 = ()
t2 = tuple()
print(type(t1), t1)
print(type(t2), t2)
...
print(Fore.GREEN + "-----  index 方法 -----")
t1 = (28, 67, 21, 67, 11)
result = t1.index(67)
print(result)

# count 方法：統計指定元素在元組中出現的次數。
print(Fore.GREEN + "-----  count 方法 -----")
t1 = (28, 67, 21, 67, 11)
result = t1.count(67)
print(result)
...
# 常用內建函式
# max 函式，傳回元組中的最大值
print(Fore.GREEN + "-----  max 方法 -----")
t1 = (23, 11, 32, 30, 17)
result = max(t1)
print(result)

# min 函式，傳回元組中的最小值
print(Fore.GREEN + "-----  min 方法 -----")
t1 = (23, 11, 32, 30, 17)
result = min(t1)
print(result)

# len 函式，傳回元組中元素的個數（元組長度）
print(Fore.GREEN + "-----  len 方法 -----")
t1 = (23, 11, 32, 30, 17)
result = len(t1)
print(result)

# sorted 函式，對元組進行排序（不修改原元組，返回一個新的列表）
print(Fore.GREEN + "-----  sorted 方法 -----")
t1 = (23, 11, 32, 30, 17)
result = sorted(t1, reverse=True)
print(tuple(result))

# sum 函式，統計元組中所有元素的和（元素必須是純數字）
print(Fore.GREEN + "-----  sum 方法 -----")
t1 = (23, 11, 32, 30, 17)
result = sum(t1)
print(result)
